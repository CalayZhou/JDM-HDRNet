...
class ONNXRuntimeSegmentor(BaseSegmentor):
    ...
    def simple_test(self, img: torch.Tensor, img_2: torch.Tensor,img_meta: Iterable,
                    **kwargs) -> list:
...
class TensorRTSegmentor(BaseSegmentor):
    ...
    def __init__(self, trt_file: str, cfg: Any, device_id: int):
        ...
        model = TRTWraper(
            trt_file, input_names=['input','input_2'], output_names=['output'])
    ...
    def simple_test(self, img: torch.Tensor, img_2: torch.Tensor, img_meta: Iterable,
        ...
        with torch.cuda.device(self.device_id), torch.no_grad():
            seg_pred = self.model({'input': img},{'input_2': img_2})['output']
